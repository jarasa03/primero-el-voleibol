...
@section('content')
    <section class="pb-8 pt-28 lg:pb-10 lg:pt-32">
        <div class="relative overflow-hidden rounded-[2.25rem] bg-slate-950 px-6 py-10 text-white shadow-[0_28px_80px_rgba(15,23,42,0.24)] sm:px-8 lg:px-10 lg:py-12">
            ...
            <div class="relative grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-start">
                ...
                <aside class="lg:mt-8 lg:justify-self-end">
        ...
        <div class="rounded-[2rem] border border-slate-200 bg-white px-6 py-8 shadow-sm sm:px-8 lg:px-10 lg:py-10">
            <div class="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-start">
                <div>
                    ...
                    <h2 class="mt-3 text-3xl font-semibold tracking-tight text-slate-950">Medidas útiles, claras y sostenibles</h2>
                </div>

                <p class="max-w-3xl text-lg leading-8 text-slate-700">
                    Estamos dando forma al programa con rigor, escuchando la realidad del voleibol madrileño y buscando medidas útiles, claras y sostenibles.
                </p>
            </div>
        </div>
    </section>

    <section id="propuestas" class="py-10 lg:py-14">
        <div class="rounded-[2.25rem] border border-slate-200 bg-slate-100 px-6 py-8 shadow-sm sm:px-8 lg:px-10 lg:py-10">
            <div class="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
                <div class="max-w-3xl">
                    <p class="text-sm font-semibold uppercase tracking-[0.25em] text-accent-700">Propuestas</p>
                    <h2 class="mt-3 text-3xl font-semibold tracking-tight text-slate-950 sm:text-4xl">
                        Tu experiencia también construye voleibol.
                    </h2>
                    <p class="mt-4 max-w-2xl text-lg leading-8 text-slate-700">
                        Cuéntanos qué cambiarías, qué mejorarías o qué crees que debería estar en el centro del debate.
                        Primero el Voleibol nace para escuchar antes de proponer.
                    </p>
                </div>
    ...
    <section id="actualidad" class="py-10 lg:py-14">
        <div class="grid gap-6 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm lg:grid-cols-[0.8fr_1.2fr] lg:p-8">
            <div>
                <p class="text-sm font-semibold uppercase tracking-[0.25em] text-slate-500">Actualidad</p>
