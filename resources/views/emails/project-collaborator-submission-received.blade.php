...
**Nivel de voleibol:** {{ $labels['refereeVolleyballLevel'] }}

@endif

@if ($submission->referee_beach_level)
**Nivel de voleyplaya:** {{ $labels['refereeBeachLevel'] }}
...
**Nivel de voleibol:** {{ $labels['coachVolleyballLevel'] }}

@endif

@if ($submission->coach_beach_level)
**Nivel de voleyplaya:** {{ $labels['coachBeachLevel'] }}
